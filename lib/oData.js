...
function parseResponse (res, body, cb) {
    ...
    try {
        ...
        winston.debug("Unable to parse response, statusCode: ", res.statusCode);
        winston.debug("Unable to parse response, body: ", body);
        winston.debug("Unable to parse response, headers: ", res.headers);
