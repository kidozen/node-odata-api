...
function OData(config) {
    ...
    this.get = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "GET";
        odataOptions.command = "/" + options.resource + "(" + buildODataId(options.id) + ")";
    ...
    this.query = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "GET";
        odataOptions.command = "/" + options.resource + (params.length === 0 ? "" : "?" + params.join("&"));
        self.oData(odataOptions, cb);
    };
    ...
    this.download = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "GET";
        odataOptions.command = "/" + options.resource + "/File";
        self.oData(odataOptions, function (err, data) {
            if (err) { return cb(err); }
            ...
            reqOptions.streaming = true;
            reqOptions.command = file.ServerRelativeUrl;
            reqOptions.location = file.ServerRelativeUrl;
    ...
    this.processQuery = function (options, cb) {
        ...
        options = options || {};
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "POST";
        odataOptions.data = options.data;
    ...
    this.links = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "GET";
        odataOptions.command = "/" + options.resource + "(" + buildODataId(options.id) + ")/$links/" + options.entity;
        self.oData(odataOptions, cb);
    };
    ...
    this.count = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "GET";
        odataOptions.command = "/" + options.resource + "/$count";
        self.oData(odataOptions, cb);
    };
    ...
    this.create = function (options, cb) {
        ...
        var odataOptions = _.cloneDeep(options);
        odataOptions.method = "POST";
        odataOptions.command = "/" + options.resource;
        self.oData(odataOptions, cb);
    };
